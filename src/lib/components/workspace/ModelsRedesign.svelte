...
{#if loaded}
	...
	<header class="flex flex-col gap-1 my-1.5 border border-slate-800 dark:border-gray-800">
	...
	<section class=" my-2 mb-5 gap-2 grid lg:grid-cols-2 xl:grid-cols-3 border border-slate-800" id="model-list">
		{#if filteredModels.length === 0}
			<div class="flex flex-col items-center justify-center w-full h-full py-4xl flex-1 border border-slate-800">
					Empty
			</div>
			{:else}
