...
{#key message.id}
	...
	>
		...
		<div class="flex-auto w-0 pl-1 text-subtitle dark:text-white text-black">
			<Name>
			...
			<div>
				...
				<div class="chat-{message.role} w-full min-w-full markdown-prose">
					<div>
						...
						{#if edit === true}
							<div class="w-full bg-gray-50 dark:bg-slate-950 rounded-sm p-sm my-2">
								<textarea
									id="message-edit-{message.id}"
									bind:this={editTextAreaElement}
									class="text-markdown-base bg-transparent outline-none w-full resize-none"
								...
								<div class=" mt-2 mb-1 flex justify-between text-sm font-medium">
									<div>
										<Button id="save-new-message-button" variant="outline-primary" onClick={() => {saveAsCopyHandler()}}>{$i18n.t('Save As Copy')}</Button>
									</div>

									<div class="flex space-x-1.5">
										<Button id="close-edit-message-button" variant="outline-primary" onClick={()=>cancelEditMessage()}>{$i18n.t('Cancel')}</Button>

										<Button id="confirm-edit-message-button" variant="primary" onClick={() => {editMessageConfirmHandler()}}>
											{$i18n.t('Save')}
										</Button>
									</div>
								</div>
								...
								{#if message.done}
									...
									<Tooltip content={$i18n.t('Copy')} placement="bottom">
										<button
											class="{isLastMessage
											? 'visible'
											: 'invisible group-hover:visible'} p-1.5 hover:bg-black/5 dark:hover:bg-white/5 rounded-lg dark:hover:text-brand-500 hover:text-brand-500 transition copy-response-button"
											on:click={() => {
									...
									{#if message.usage}
										...
										>
											<button
												class=" {isLastMessage
												? 'visible'
												: 'invisible group-hover:visible'} p-1.5 hover:bg-black/5 dark:hover:bg-white/5 rounded-lg dark:hover:text-brand-500 hover:text-brand-500 transition whitespace-pre-wrap"
												on:click={() => {
												console.log(message);
											}}
												id="info-{message.id}"
